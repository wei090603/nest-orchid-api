...
INSERT INTO `article` VALUES ('21', '<p>测试发测试「时光不负，创作不停，本文正在参加2022年中总结征文大赛」 落户 关于落户这个事, 就是一个很突然的想法,很突然, 得知天津有个\"海河英才计划\",只要是本科生, 就比较容易落户,所以就想着试一试,</p>', '如果你的项目是 ToB 项目，可能性能优化不会做到极致；', '1658382145923.jpeg', '358', '1', '0', null, '2', '4', '1', '0', '10', '2022-12-27 10:08:25.000000', '2022-07-28 15:10:32', null, '这不又来事了，这两天又爆了互联网大裁员。继阿里“向社会输送人才”之后，京东又搞了个“毕业礼”，整的小伙伴们人心惶惶。副业的关注度又一波升级。那今天我们就来聊聊，程序员做副业这件事。', '1658382145923.jpeg');
INSERT INTO `article` VALUES ('22', '<p>测试稳住文章</p>', '测试', null, '1', '1', '0', null, '0', '0', '5', '1', '1', '2022-12-21 15:39:03.000000', '2022-12-21 15:36:35', null, '测试稳住文章', '1671890013450.png');
INSERT INTO `article` VALUES ('23', '<p>wezdaefwe<img src=\"http://127.0.0.1:4000/uploads/1671863567054.png\" alt=\"1671863567054.png\" data-href=\"\" style=\"width: 789.00px;height: 678.06px;\"/></p>', '测试文章2', null, '0', '1', '0', null, '0', '0', '2', '1', '1', '2022-12-22 11:39:28.311157', '2022-12-22 11:39:28', null, 'wezdaefwe', '1671848847576.png');
INSERT INTO `article` VALUES ('24', '<p>wezdaefwe<img src=\"http://127.0.0.1:4000/uploads/1671863567054.png\" alt=\"1671863567054.png\" data-href=\"\" style=\"width: 789.00px;height: 678.06px;\"/></p>', '测试文章2', null, '50', '1', '0', null, '1', '0', '2', '1', '1', '2022-12-23 13:21:27.000000', '2022-12-22 11:39:37', null, 'wezdaefwe', '1671848847576.png');
INSERT INTO `article` VALUES ('25', '<p>测试时玩了快解放了我<img src=\"http://127.0.0.1:4000/uploads/1671921522659.png\" alt=\"1671921522659.png\" data-href=\"\" style=\"\"/></p>', '测试文章3', null, '55', '1', '0', null, '1', '0', '7', '1', '1', '2022-12-26 20:09:49.000000', '2022-12-22 11:43:29', null, '测试时玩了快解放了我', '1671986730962.png');
...
CREATE TABLE `manager` (
  ...
  `password` varchar(200) NOT NULL DEFAULT '$2a$10$ByCi2akaah9BynSc5S.g6OR.hKyIzL.XulVavp/bbNr7czCRmsu/u' COMMENT '用户登录密码',
...
-- Records of sign
-- ----------------------------
INSERT INTO `sign` VALUES ('1', '50', '2022-12-08');
INSERT INTO `sign` VALUES ('10', '5', '2022-11-01');
INSERT INTO `sign` VALUES ('10', '5', '2022-11-05');
INSERT INTO `sign` VALUES ('10', '5', '2022-11-06');
INSERT INTO `sign` VALUES ('10', '5', '2022-11-08');
INSERT INTO `sign` VALUES ('10', '50', '2022-11-09');
INSERT INTO `sign` VALUES ('10', '5', '2022-12-01');
...
-- Records of user
-- ----------------------------
INSERT INTO `user` VALUES ('1', 'test', '$2a$10$lrIDbrWVSAIzshOKgFHNr.OEgRgIeOSQq3pWZjfCLLKbfDyCxxD1O', '测试1', '17802093443', '1176022890@qq.com', '50', '1', '0', '1', '', '1', null, '来将可留姓名~', '0', 'default_avatar.png', null, '1', '2022-12-08 16:06:59.000000', '2022-07-28 15:10:29', null);
...
INSERT INTO `user` VALUES ('10', 'test3', '$2a$10$lrIDbrWVSAIzshOKgFHNr.OEgRgIeOSQq3pWZjfCLLKbfDyCxxD1O', '我是测试', '17223110317', 'fewfew@qq.com', '235', '2', '0', '1', '', '1', null, null, '0', 'default_avatar.png', null, '1', '2022-11-09 17:45:32.222836', '2022-07-28 15:10:29', null);
INSERT INTO `user` VALUES ('11', 'test4', '$2a$10$lrIDbrWVSAIzshOKgFHNr.OEgRgIeOSQq3pWZjfCLLKbfDyCxxD1O', '我是测试3', '17323110316', 'feewfw@qq.com', '0', '0', '0', '1', '', '1', null, '为什么', '0', 'default_avatar.png', null, '1', '2022-12-23 17:51:33.847387', '2022-12-23 17:48:50', null);

-- ----------------------------
-- Table structure for user_read_like
-- ----------------------------
DROP TABLE IF EXISTS `user_read_like`;
CREATE TABLE `user_read_like` (
  `id` int(11) NOT NULL AUTO_INCREMENT COMMENT '主键id',
  `created_at` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建日期',
  `updated_at` timestamp(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6) COMMENT '更新日期',
  `delete_at` timestamp(6) NULL DEFAULT NULL COMMENT '软删除时间',
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `IDX_72ce7a0b72a2863cd1c23d1cf5` (`user_id`)
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=utf8;

-- ----------------------------
-- Records of user_read_like
-- ----------------------------
INSERT INTO `user_read_like` VALUES ('2', '2022-12-22 14:00:03', '2022-12-27 10:08:25.000000', null, '10', '2', '228');
INSERT INTO `user_read_like` VALUES ('3', '2022-12-22 16:33:17', '2022-12-26 20:09:49.000000', null, '1', '2', '93');
