...
-- Records of article
-- ----------------------------
INSERT INTO `article` VALUES ('1', '<p>测试发测试「时光不负，创作不停，本文正在参加2022年中总结征文大赛」 落户 关于落户这个事, 就是一个很突然的想法,很突然, 得知天津有个\"海河英才计划\",只要是本科生, 就比较容易落户,所以就想着试一试,</p>', '111', '1658382145923.jpeg', '1', '1', '0', null, '0', '0', '1', '0', '10', '2022-09-15 21:45:48.000000', '2022-07-28 15:10:32', null, '以前有个朋友是恒大的，公司让买理财，宁死不屈，就说没钱就没买，躲过一劫。\n\n后来一个半月没发工资，扛不住了，就跳槽了。', '1658382145923.jpeg');
...
INSERT INTO `article` VALUES ('3', '<p><br></p>', '的', '1659892913785.jpeg', '0', '1', '0', null, '0', '0', '1', '0', '1', '2022-09-14 11:41:10.368930', '2022-07-28 15:10:32', null, '以前有个朋友是恒大的，公司让买理财，宁死不屈，就说没钱就没买，躲过一劫。\n\n后来一个半月没发工资，扛不住了，就跳槽了。', '1658382145923.jpeg');
...
INSERT INTO `article` VALUES ('21', '<p>测试发测试「时光不负，创作不停，本文正在参加2022年中总结征文大赛」 落户 关于落户这个事, 就是一个很突然的想法,很突然, 得知天津有个\"海河英才计划\",只要是本科生, 就比较容易落户,所以就想着试一试,</p>', '如果你的项目是 ToB 项目，可能性能优化不会做到极致；', '1658382145923.jpeg', '14', '1', '0', null, '0', '0', '1', '0', '10', '2022-09-23 10:43:49.000000', '2022-07-28 15:10:32', null, '这不又来事了，这两天又爆了互联网大裁员。继阿里“向社会输送人才”之后，京东又搞了个“毕业礼”，整的小伙伴们人心惶惶。副业的关注度又一波升级。那今天我们就来聊聊，程序员做副业这件事。', '1658382145923.jpeg');
...
CREATE TABLE `manager` (
  ...
  `password` varchar(200) NOT NULL DEFAULT '$2a$10$ndL4N0wjEQxLyL21ElpY5ePQwMbFC/oclNZv6N0xO08qneFm8FkzS' COMMENT '用户登录密码',
